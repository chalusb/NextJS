...
const versions = [
    {
        name: "Ampbiente",
        price: "$599,000",
        image: "/assets/img/Territory 25/des/versiones/ford-territory-2025-suv-camioneta-lujo-tecnologia-version-ambiente.jpg"
    },
    {
        name: "Trend",
        price: "$705,000",
        image: "/assets/img/Territory 25/des/versiones/ford-territory-2025-suv-camioneta-lujo-tecnologia-version-trend.jpg"
    },
    {
        name: "Titanium",
        price: "$770,000",
        image: "/assets/img/Territory 25/des/versiones/ford-territory-2025-suv-camioneta-lujo-tecnologia-version-titanium.jpg"
    },
    {
        name: "Dark Edition",
        price: "$795,000",
        image: "/assets/img/Territory 25/des/versiones/ford-territory-2025-suv-camioneta-diseno-edicion-dark-edition-detalles.jpg"
    }
]
            ...
            <div className="mx-auto 2xl:container px-4">
                ...
                <div className="hidden lg:flex justify-between items-center mb-12">
                    <h2 className="text-4xl font-light">
                        Versiones de Ford Territory 2025
                    </h2>
                    <button
